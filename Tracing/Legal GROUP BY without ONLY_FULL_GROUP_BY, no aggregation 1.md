Confirmed default behavior in MySQL is `ANY_VALUE` returns the first row retrieved from the storage engine. Want to make sure this is the case for MariaDB to ensure consistent results
## Executed
